...
import NativeControl, { NativeControlProps } from './NativeControl';
export interface RadioProps extends InjectedProps<HTMLDivElement, HTMLInputElement>, React.HTMLProps<HTMLDivElement> {
    label?: string;
